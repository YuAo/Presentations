...
extension CGPath {
	...
	fileprivate static func point(at length: CGFloat, for elements: [PathElement]) -> CGPoint? {

		let percentLength = length
	...
	fileprivate static func length(for elements: [PathElement]) -> CGFloat {
	...
	// MARK: - Linear
	private static func linearLength(p0: CGPoint, p1: CGPoint) -> CGFloat {
		return p0.distance(to: p1)
	}

    private static func linearPoint(t: CGFloat, p0: CGPoint, p1: CGPoint) -> CGPoint {
    ...
    private static func linearValue(t: CGFloat, p0: CGFloat, p1: CGFloat) -> CGFloat {
    ...
    private static func quadCurveLength(p0: CGPoint, c1: CGPoint, p1: CGPoint) -> CGFloat {
    ...
    private static func quadCurvePoint(t: CGFloat, p0: CGPoint, c1: CGPoint, p1: CGPoint) -> CGPoint {
    ...
    private static func quadCurveValue(t: CGFloat, p0: CGFloat, c1: CGFloat, p1: CGFloat) -> CGFloat {
    ...
    private static func cubicCurveLength(p0: CGPoint, c1: CGPoint, c2: CGPoint, p1: CGPoint) -> CGFloat {
    ...
    private static func cubicCurvePoint(t: CGFloat, p0: CGPoint, c1: CGPoint, c2: CGPoint, p1: CGPoint) -> CGPoint {
    ...
    private static func cubicCurveValue(t: CGFloat, p0: CGFloat, c1: CGFloat, c2: CGFloat, p1: CGFloat) -> CGFloat {
...
public extension Array where Element == PathElement {
    
    var pathLength: CGFloat {
        CGPath.length(for: self)
    }
    
    func point(atPathLength length: CGFloat) -> CGPoint? {
        CGPath.point(at: length, for: self)
    }
}
